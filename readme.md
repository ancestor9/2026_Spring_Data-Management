...
| machine Leraning | sikit-learn, keras, tensorflow, pytorch | Database([sqlite3](https://sqlite.org/), [supabase](https://supabase.com/)) | 4. 머신러닝 모델을 백엔드로 하는 예측 서비스 만들기 (FastAPI, Streamlit) |
